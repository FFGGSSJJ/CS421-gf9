...
-   revision: 2.1 - Upgraded test suite, slightly changed directory structure
...
The syntactic unrolling of this function can be found in `src/Scheme/Parse.hs`, along with
